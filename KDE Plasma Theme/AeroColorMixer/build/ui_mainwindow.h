...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        MainWindow->resize(904, 580);
        MainWindow->setMinimumSize(QSize(776, 565));
        QIcon icon(QIcon::fromTheme(QString::fromUtf8("style")));
        ...
        colorMixerLabel->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByMouse);
        ...
        sizePolicy2.setHeightForWidth(alpha_slider->sizePolicy().hasHeightForWidth());
        alpha_slider->setSizePolicy(sizePolicy2);
